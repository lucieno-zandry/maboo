...
import { setCategoryProducts } from "../../../utilities/redux/frontoffice/frontofficeSlice";
...
const Category = React.memo(() => {
    ...
    const products = useSelector((state: Rootstate) => state.frontoffice.categoryProducts[selectorId]);
